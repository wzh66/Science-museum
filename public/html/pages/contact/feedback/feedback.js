...
app.config(['$routeProvider', '$locationProvider', function ($routeProvider, $locationProvider) {
    ...
    // 设定路由
    $routeProvider
        .when('/contact/feedback', { //科学馆新闻
            templateUrl: 'pages/contact/feedback/feedback.html',
            controller: "contactFeedbackController"
        });
}]).controller('contactFeedbackController', ['$scope', 'indexSvc', 'contactSvc', 'authSvc', function ($scope, indexSvc, contactSvc, authSvc) {
    ...
    $scope.submit = function (form) {
        ...
        contactSvc.suggest(body).then(function success(res) {
